-- Taken from https://github.com/folke/lazy.nvim/blob/6e66f8e6550dd22467c11284e638dfccb5d514e4/lua/lazy/terminal.lua
...
function M.error(message)
    io.write(M.prefix(message, M.red("error: ")) .. "\n")
end

function M.help(message)
    io.write(M.prefix(message, M.cyan("help: ")) .. "\n")
end
